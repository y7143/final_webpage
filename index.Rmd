...
Our dataset is a real- time updated dataset downloaded from [NYC Open Data](https://opendata.cityofnewyork.us/). It consists of breakdown and delay information of school buses in New York during 2015-2016, 2016-2017 and 2017-2018 school years (except July, August and September), including 168462 observations of 20 variables about the occur and inform time, delay duration, breakdown and delay reasons, and other operation information. 
...
* Describe and explore the data according to time, boros, reasons, companies and other categorical variables we are interested in, visualized by barplots, scatter plots and tables
...
* The most common reasons for breakdown are *mechanical problem*, *won’t start* and *flat tire*. The most common reasons for delay is *heavy traffic*.

* *Accident* and *mechanical problem* tend to cause the longest delay duration while *delayed by school* and *heavy traffic* tend to cause the shortest delay duration.
...
* The ratio of work faults(reaction time is negative because of falsely recorded or more than one day) is quite small generally. The company *“IC BUS INC.”* has the largest ratio of work faults, followed by *“GRANDPA`S BUS CO., INC.”* and *“ACME BUS CORP.”*.

* Route planning has a negative effect on the school bus arriving in time because of inflexibility. The route service for Pre-K has a much higher odds of notifying and shorter average delay duration because of running late compared to School-Age. 
